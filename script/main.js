...
const animationTimeline = () => {
    ...
    .from(".step-1", 0.7, ideaTextTrans)
    .to(".step-1", 0.7, ideaTextTransLeave, "+=1.5")
    ...
    .from(".step-5", 0.7, ideaTextTrans)
    .addPause()
    .to(".step-5", 0.7, ideaTextTransLeave)
    .staggerFromTo(
        ".baloons img",
        2.5,
        {
    ...
    code3Btn.addEventListener("click", () => {
        ...
        step5.style.zIndex = 16;
    });
    const code4Btn = document.getElementById("codeBtn4");
    code4Btn.addEventListener("click", () => {
        tl.paused(false);
        step5.style.zIndex = 15;
